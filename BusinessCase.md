...
| O-3 | Удержать совокупный бюджет проекта в плановых рамках                       | ≤86 475 крышек по факту закрытия пилота (см. [SDP 4.2.6](SDP.md)) |
...
Риски проекта (R1–R7) полностью описаны и сопровождаются стратегиями ответа в [SDP 4.4](SDP.md). В рамках бизнес-обоснования дополнительно выделены коммерческие риски, влияющие на окупаемость продукта:
...
| Elaboration | 06.04.2026 — 03.05.2026 (2 итерации) | 398 ч. | 7 612 |
| Construction | 04.05.2026 — 29.11.2026 (15 итераций) | 2 878 ч. | 51 512 |
| Transition | 30.11.2026 — 31.12.2026 (2 итерации) | 366 ч. | 5 648 |
| **Итого разработка** | **41 неделя** | **3 798 ч.** | **67 804** |

### 5.2 Полный бюджет проекта

| Статья бюджета | Сумма, крышек | Комментарий |
|----------------|---------------|-------------|
| Базовая разработка | 67 804 | Трудозатраты трёх исполнителей по RUP-ролям ([SDP 4.2.4](SDP.md)) |
...
| Резерв по рискам (≈15% от разработки) | 10 171 | Покрытие технологических, интеграционных и ресурсных отклонений без пересмотра базового scope |
| **ИТОГО** | **86 475** | Плановый бюджет проекта до релиза `v1.0.0` и закрытия пилота |
...
Прогноз клиентской базы и MRR (Monthly Recurring Revenue) после релиза `v1.0.0`. Предполагается, что у клиента в среднем 4 активные точки доступа.
...
- Совокупные инвестиции до релиза `v1.0.0`: **86 475 крышек** (см. 5.2).
...
- Кумулятивная чистая прибыль покрывает инвестиции в районе **+17–18 месяцев** после релиза (≈+27 месяцев от старта проекта 23.03.2026, то есть во второй половине 2028 г.).
- ROI на горизонте 4 лет от старта (к концу 2030 г.) — ориентировочно **200–260%**.
