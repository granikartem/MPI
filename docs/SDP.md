...
| Загрузка | Ни один исполнитель не планируется более чем на 40 часов в неделю. Для стандартной двухнедельной итерации лимит составляет 80 часов на человека; максимальная плановая нагрузка - 80 часов за итерацию. |
...
Для проекта формируется компактная кросс-функциональная команда из 3 человек. Роль в плане не равна человеку: один исполнитель может закрывать несколько RUP-ролей, а расчёт стоимости ведётся по фактическим часам в каждой роли.
