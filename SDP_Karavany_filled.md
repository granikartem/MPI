...
Информационная система «Караваны»

План разработки продукта подготовлен на основе Vision, SRS, Glossary и Use Cases для проекта автоматизации караванных перевозок в мире Fallout: New Vegas.

| Параметр | Значение |
| --- | --- |
| Проект | ИС «Караваны» |
| Версия документа | 1.0 |
| Статус | Baseline draft for review |
| Дата | 15.04.2026 |
| Базовые артефакты | Vision, SRS, Glossary_Karavany_FNV, UseCases, PUML use case diagrams |
| Плановый горизонт | 23.03.2026 - 16.08.2026 (21 неделя) |

Примечание.

Все численные оценки трудозатрат, стоимости и дат в настоящем SDP являются плановыми. Они рассчитаны на один пилотный контур внедрения, одну продуктовую команду и фиксированный технологический стек, закреплённый в SRS.

## История версий документа

| Версия | Дата | Описание изменения | Основание |
| --- | --- | --- | --- |
| 0.1 | 24.03.2026 | Первичная заготовка плана разработки на основе Vision и перечня стейкхолдеров. | Старт проекта |
| 0.5 | 03.04.2026 | Уточнены границы MVP , роли команды и фазовый план. | Появление согласованных SRS и Use Cases |
| 1.0 | 15.04.2026 | Сформирована полная базовая версия SDP с бюджетом, рисками, контролями и планом релизов. | Готовность требований к baseline |
...
| DevOps Engineer | 0.5 | Inception - Transition | Окружения, сборка, деплой, мониторинг, backup/restore, release automation. |
...
| DevOps Engineer | CI/CD, Docker/окружения, observability, backup/restore, security hardening. | 0.5 | Elaboration, Transition |
